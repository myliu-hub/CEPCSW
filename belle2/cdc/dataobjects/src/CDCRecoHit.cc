...
genfit::SharedPlanePtr CDCRecoHit::constructPlane(const genfit::StateOnPlane& state) const
{
  ...
  TVector3 noSagWire1T,noSagWire2T;
  ...
  GeomeryWire::Get()->getSeg()->cellposition2(0,0,0,noSagWire1T,noSagWire2T);
  std::cout << __FILE__ << " " << __LINE__ << " noSagWire1T = " << std::endl;
  noSagWire1T.Print();
  std::cout << __FILE__ << " " << __LINE__ << " noSagWire2T = " << std::endl;
  noSagWire2T.Print();
  //GeomeryWire::Get()->getWirePos(m_wireID.getILayer(),m_wireID.getIWire(),noSagWire1,noSagWire2);
