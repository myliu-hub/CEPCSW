...
//    std::vector<Belle2::RecoTrack::UsedEKLMHit*> getSortedEKLMHitList() const { return getSortedHitList<UsedEKLMHit>(m_storeArrayNameOfEKLMHits); }
    ...
    */
    ...
    /** Return genfit's MeasuredStateOnPlane for the extrapolation of measurements
     */

    const genfit::MeasuredStateOnPlane& getMeasuredStateOnPlaneExtrapolation(int id = -1) const;
...
//    }
  ...
  public:
    ...
    static bool AddTrackRep(RecoTrack& recoTrack, genfit::AbsTrackRep* rep);
